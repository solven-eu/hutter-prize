package eu.solven.hutter_prize.recurrent_java.util;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import eu.solven.hutter_prize.recurrent_java.model.FeedForwardLayer;
import eu.solven.hutter_prize.recurrent_java.model.GruLayer;
import eu.solven.hutter_prize.recurrent_java.model.LinearLayer;
import eu.solven.hutter_prize.recurrent_java.model.LstmLayer;
import eu.solven.hutter_prize.recurrent_java.model.Model;
import eu.solven.hutter_prize.recurrent_java.model.NeuralNetwork;
import eu.solven.hutter_prize.recurrent_java.model.Nonlinearity;
import eu.solven.hutter_prize.recurrent_java.model.RnnLayer;
